   ...
   <div class="col-md-12">
    <?php
            ...
            while($result=mysqli_fetch_assoc($res)){
              ...
              ?>
              <div class="card mx-auto" style="width: 51%">
              <div class="container ">
              <div class="row">
              <h5 style="text-align:center;">Lower Deck</h5>
             ...
             ?>
              ...
              if($result['status']=='booked'){
                ...
                if($result['status']=='booking'){
                  echo "<form method='POST' action='trailserver2.php'>";
            ...
            <div class="card mx-auto" style="width: 51%">
              <div class="container ">
              <div class="row">
              <h5 style="text-align:center;">Upper Deck</h5>
              <div class="col-sm-12 d-flex text-align-center">
            ...
            <div class="card mx-auto mt-4 p-3" style="width: 18rem">
              ...
              echo "<form method='POST' action='prebooked1.php'>";
