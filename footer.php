...
<footer class="page-footer font-small unique-color-dark mt-5">
  ...
  <div class="container text-white text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
        ...
        <p>Ride a Yolo today for a comfortable, on-time, safe ride and experience the next generation inter-city transportation network and mobility platform in your vicinity!</p>
      ...
      <!-- Grid column -->
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4" style="margin-top: -15px;">
      ...
      <!-- Grid column -->
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4" style="margin-top: -15px;">
        ...
        <p>
          <a href="agent.php">Agent Registration</a>
        </p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" style="margin-top: -10px;">
        ...
        <p>
          <i class="fas fa-phone mr-3"></i>+91 7987987956</p>
        ...
        <div class="col-lg-8 text-center text-md-right">
          ...
          <!-- Facebook -->
          <a class="fb-ic">
            <i class="fab fa-facebook-f white-text p-1"> </i>
          </a>
          <!-- Twitter -->
          <a class="tw-ic">
            <i class="fab fa-twitter white-text p-1"> </i>
          </a>
          <!-- Google +-->
          <a class="gplus-ic">
            <i class="fab fa-google-plus-g white-text p-1"> </i>
          </a>
          <!--Linkedin -->
          <a class="li-ic">
            <i class="fab fa-linkedin-in white-text p-1"> </i>
          </a>
          <!--Instagram-->
          <a class="ins-ic">
            <i class="fab fa-instagram white-text p-1"> </i>
          </a>
  ...
  <!-- Copyright -->
  <div class="container-fluid" style="color: white; padding-top: 10px;background-color: black;">
    <div class="row">
      <div class="col-12">
        <div class="copywrite-content text-center">
          <p>
            ...
            <a href=" " target="_blank">Bus Brand</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
