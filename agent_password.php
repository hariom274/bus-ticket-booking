...
<div class="sidebar bg-light">
  ...
  <a href="agent_password.php" style="text-transform: uppercase;border-bottom: 1px solid #00cc7a;font-size: 15px "><i class="fas fa-bus " style="margin-right: 5px;color: black"></i>Bus's & Routes</a>
  <!-- <hr style="padding-top: 0;margin: 0;"> -->

  <a href="#" style="text-transform: uppercase;border-bottom: 1px solid #00cc7a;font-size: 15px "><i class="fas fa-unlock-alt " style="margin-right: 5px;color: black"></i>Change Password</a>
  <!-- <hr style="padding-top: 0;margin: 0;"> -->
  ...
  <div class="row">
    <div class="col-md-12" style="overflow: hidden;" >
      <div class="input_box">
        ...
        <input type="text" name="oldpassword" placeholder="Old Password" style="padding: 5px" required><br>
        <input type="text" name="newpassword" placeholder="New Password" style="padding: 5px" required><br>
        <input type="text" name="cnewpassword" placeholder="Confirm Password" style="padding: 5px" required><br>
        ...
        <?php
         ...
         if(isset($_POST['change']))
         {
          ...
          if ($result->num_rows == 1)
          {
           ...
           $q="UPDATE `agent` SET `password`='$newpassword',`cpassword`='$newpassword' WHERE email='$email' ";
