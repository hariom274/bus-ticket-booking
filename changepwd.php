...
<div class="sidebar bg-light">
  ...
  <a href="logout.php" style="text-transform: uppercase;border-bottom: 1px solid #00cc7a;font-size: 15px "><i class="fas fa-sign-out-alt " style="margin-right: 5px;color: black"></i>Log Out</a>
  <!-- <hr style="padding-top: 0;margin: 0;"> -->
...
<div class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-12" style="overflow: hidden;" >
      <div class="input_box">
        ...
        <input type="text" name="previous_password" placeholder="Previous Password" style="padding: 5px">
        <input type="text" name="new_password" placeholder="New Password" style="padding: 5px">
        <input type="password" name="confirm_password" placeholder="Confirm Password" style="padding: 5px">
  ...
  <?php
         ...
         {
          $oldpassword= mysqli_real_escape_string($con,$_POST['previous_password']);
          $newpassword= mysqli_real_escape_string($con,$_POST['new_password']);
          $cnewpassword= mysqli_real_escape_string($con,$_POST['confirm_password']);
          ...
          if ($result->num_rows == 1)
          {
           ...
           $q="UPDATE `user_management` SET `password`='$newpassword',`cpassword`='$newpassword' WHERE email='$email' ";
