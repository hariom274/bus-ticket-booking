    ...
    <form method="post" action="prebookedserver.php" >
     ...
     ?>
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" value="<?php echo $amount ?>" name="amount" placeholder="enter amount">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" value=" <?php echo $result['atime']; ?>"name="atime" placeholder="enter arrival time">
            </div>
          </div>
        </div>
        <div class="form-group">
